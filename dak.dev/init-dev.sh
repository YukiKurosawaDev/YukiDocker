...
$USER_CMD $DAK admin suite add-all-arches focal 22.04.1 origin=KSLinux label=Focal codename=focal signingkey=451DD5811062DFC93DF54EEC259531ED17EE37C1 1>/dev/null 2>&1

$USER_CMD $DAK admin s-c add focal main restricted universe multiverse 1>/dev/null 2>&1
